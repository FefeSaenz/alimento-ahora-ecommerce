...
const FilterBar: React.FC<FilterBarProps> = ({ 
  ...
  return (
    // Contenedor principal: Sticky abajo del Header
    <div id="shop-section" className="sticky top-20 z-30 bg-white/95 backdrop-blur-md border-b border-gray-100 w-full shadow-sm">
      ...
      <div className="w-full flex flex-col lg:flex-row lg:items-center justify-between lg:max-w-360 lg:mx-auto lg:px-6">
        ...
        <div className="flex flex-row w-full lg:w-auto bg-gray-50 lg:bg-transparent">
            ...
            {/* 3. ORDENAR */}
            <div className="flex-1 lg:flex-none flex items-center justify-center lg:justify-end py-3 lg:py-0 space-x-2 lg:space-x-3">
              <span className="hidden lg:inline text-[10px] lg:text-xs font-fredoka font-bold uppercase text-gray-500 tracking-wider">
                Ordenar por:
              </span>
              
              <div className="flex items-center space-x-2 lg:bg-white lg:border-2 lg:border-gray-100 lg:rounded-full lg:px-3 lg:py-1.5 transition-all focus-within:border-brand-primary">
