...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-40 flex flex-col items-end gap-3 pointer-events-none">
      ...
      {/* BURBUJA DE TEXTO (hidden md:flex la oculta en celulares) */}
      <div className="hidden md:flex relative bg-white text-gray-800 px-3 py-2 rounded-2xl shadow-xl border border-gray-100 animate-bounce-pause pointer-events-auto items-center justify-center">
